                ...
                <div class="ke-hero-info">
                    ...
                    <div class="ke-hero-share">
                        <a href="https://wa.me/?text=<?php echo $share_title; ?>%20<?php echo $share_url; ?>"
                           target="_blank" rel="noopener" class="ke-share-pill" aria-label="Share on WhatsApp">
                        ...
                        <a href="https://www.snapchat.com/scan?attachmentUrl=<?php echo $share_url; ?>"
                           target="_blank" rel="noopener" class="ke-share-pill" aria-label="Share on Snapchat">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                                <path d="M12.206.793c.99 0 4.347.276 5.93 3.821.5 1.14.373 3.039.299 4.09l-.007.098c-.032.416-.05.643.166.795.184.13.476.163.715.163.22 0 .46-.032.694-.095.16-.044.33-.072.497-.072.316 0 .818.148.818.659 0 .423-.349.745-.864.955-.124.05-.249.095-.374.138-.42.141-.816.274-1.03.486-.131.13-.171.294-.126.513.256 1.255 1.178 4.27 4.474 5.332.05.016.089.063.089.117 0 .436-2.019 1.508-4.208 1.508-.253 0-.508-.019-.762-.056-.495-.074-.96-.226-1.371-.36-.378-.126-.701-.232-.985-.232-.31 0-.643.11-1.03.229-.537.163-1.14.346-1.883.346-.743 0-1.347-.183-1.883-.346-.388-.12-.72-.23-1.03-.23-.284 0-.608.107-.986.233-.41.134-.876.286-1.37.36-.255.037-.51.056-.763.056-2.19 0-4.208-1.072-4.208-1.508 0-.054.039-.1.089-.117 3.296-1.062 4.218-4.077 4.474-5.332.045-.22.005-.383-.126-.513-.214-.212-.61-.345-1.03-.486-.125-.043-.25-.088-.374-.138-.515-.21-.864-.532-.864-.955 0-.51.502-.659.818-.659.167 0 .337.028.497.072.234.063.474.095.694.095.24 0 .531-.033.715-.163.216-.152.198-.379.166-.795l-.007-.098c-.074-1.051-.201-2.95.299-4.09C7.859 1.07 11.216.793 12.206.793z"/>
                            </svg>
                        </a>

                        <a href="instagram://library" class="ke-share-pill"
                           onclick="navigator.clipboard.writeText('<?php echo esc_js( $permalink ); ?>');this.classList.add('ke-share-copied');var b=this;setTimeout(function(){b.classList.remove('ke-share-copied');},2000);return false;"
                        ...
                        <button type="button" class="ke-share-pill"
                                onclick="navigator.clipboard.writeText('<?php echo esc_js( $permalink ); ?>');this.classList.add('ke-share-copied');var b=this;setTimeout(function(){b.classList.remove('ke-share-copied');},2000);"
