...
define( 'KE_BUILDER_ASSETS_VER', '0.15.0' );
...
define( 'KE_ADMIN_CSS_VER', '0.19.0' );
...
require_once KE_PLUGIN_DIR . 'includes/class-ke-coupons.php';
...
require_once KE_PLUGIN_DIR . 'includes/class-ke-analytics-history.php';
...
require_once KE_PLUGIN_DIR . 'admin/class-ke-admin-coupons.php';
